...
interface ICardMainProps {
  description: string;
  experState: [string, string][];
  eduState: [string, string][];
}

export default function CardMain({ description, experState, eduState }:ICardMainProps) {
  const expers = []
  const edus = []
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        <h3 className="border-b text-orange-700 border-gray-300 text-2xl font-semibold capitalize">
          description
        </h3>
