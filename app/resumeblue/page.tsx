...
import Button from '@/components/resumeblue/Button'
import Header from '@/components/resumeblue/HeaderCV'
import Form from '@/components/resumeblue/Form'
import Card from '@/components/resumeblue/Card'
import Footer from '@/components/resumeblue/Footer'
import Input from '@/components/resumeblue/Input'
import { useRouter } from 'next/navigation'



export default function ResumeBlue() {
